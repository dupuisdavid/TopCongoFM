...
public class PullToRefreshListView extends ListView {
    ...
    private SimpleDateFormat lastUpdatedDateFormat = new SimpleDateFormat("dd/MM HH:mm", Locale.getDefault());
    ...
    private class HeaderAnimationListener implements AnimationListener {
        ...
        public void onAnimationStart(Animation animation){
            ...
            height = lp.height;
//          Log.i("getHeight() + translation", "" + getHeight() + ", " + translation + " = " + (getHeight() - translation));
